...
class DayPickerKeyboardShortcuts extends React.Component {
  ...
  onKeyDown(e) {
    ...
    switch (e.key) {
      ...
      // only stopPropagation here - this allows the up and down arrows continue their default behavior of
      // scrolling the content of the Keyboard Shortcuts Panel which is needed when
      // only a single month is shown for instance.
      case 'ArrowUp':
      case 'ArrowDown':
        e.stopPropagation();
        break;
